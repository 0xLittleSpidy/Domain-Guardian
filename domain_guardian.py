#!/usr/bin/env python3
"""
Domain Guardian - Typosquat Detection Tool
"""
...
class DomainGuardian:
    ...
    def parse_arguments(self) -> argparse.Namespace:
        ...
        parser = argparse.ArgumentParser(
            description='Domain Guardian - Defensive Typosquat Detection Tool\n'
                       'Identify potential typosquats for brand protection and cybersecurity research',
            formatter_class=argparse.RawDescriptionHelpFormatter,
            epilog='Examples:\n'
                   '  python domain_guardian.py -d example.com\n'
                   '  python domain_guardian.py -df domains.txt -o results.csv\n'
                   '  python domain_guardian.py -d example.com -r 5 --debug'
        )
